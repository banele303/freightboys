...
const features = [
  {
    ...
    description: "Our dedicated team ensures the highest level of care and precision for all your trade in requirements.",
  },
  {
    icon: Award,
...
const galleryImages = [
  { src: "/new-img/new-img4.jpeg", alt: "Trade In Operations 1" },
  { src: "/new-img/new-img6.jpeg", alt: "Trade In Operations 2" },
  { src: "/new-img/new-img8.jpeg", alt: "Trade In Operations 3" },
];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceHero
        title="Trade"
        subtitle="In"
        description="Comprehensive trade in services tailored to meet your most demanding logistics and operational needs. We prioritize speed, security, and elite precision."
      ...
      <section className="py-24 md:py-32 bg-[#f8fafc]">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              Browse a snapshot of our trade in processes in action, handled meticulously by our expert logistics personnel.
            </motion.p>
          </motion.div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-lg md:text-2xl text-slate-500 font-medium mb-16 max-w-3xl mx-auto italic leading-relaxed">
               Get in touch with us today to discuss your specific requirements and receive a customized plan for our trade in service.
            </p>
