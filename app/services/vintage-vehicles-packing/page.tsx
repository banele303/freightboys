...
export default function VintageVehiclesPackingPage() {
  return (
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="container mx-auto px-6 relative z-10 pt-20">
          ...
          >
            ...
            >
              Relocating to New Zealand? We handle the receiving, inspection, and relocation of your collectors' vehicles with absolute perfection.
            </motion.p>
            <motion.div
              variants={fadeInUp}
              className="text-4xl md:text-6xl font-black text-[#2563eb] mb-12"
            >
              R 3,950.00 <span className="text-lg text-slate-400 font-medium italic">/ Receiving & Lashing</span>
            </motion.div>
            <motion.div
              variants={fadeInUp}
            ...
            >
              <Button asChild size="xl" className="h-20 px-12 rounded-[24px] bg-[#2563eb] hover:bg-[#1d4ed8] text-white text-xl shadow-2xl shadow-blue-500/20 border border-white/10 group overflow-hidden relative font-black uppercase tracking-widest">
                <Link href="/contact" className="flex items-center gap-3">
                  <span className="relative z-10">Secure My Shipment</span>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <motion.div
              ...
              className="space-y-8"
            >
              <h2 className="text-5xl font-black tracking-tighter text-slate-900 uppercase italic">Scratch & <br/><span className="text-primary italic">Dent Free.</span></h2>
              <p className="text-xl text-slate-500 font-medium leading-relaxed italic">
                Our team ensures your prized vehicles are carefully driven in and lashed to perfection. We guarantee that your vehicle will be received on the other end in the exact same condition it was sent.
              </p>
              <div className="space-y-4">
                {[
                  "Specialized vehicle relocation to New Zealand 🇳🇿",
                  "Professional receiving and multi-point inspection",
                  "Expert internal driving and precision lashing",
                  "Full scratch and dent prevention protocol",
                  "Comprehensive condition reports for owners",
                ].map((item, i) => (
            ...
            <div className="relative aspect-square rounded-[60px] overflow-hidden shadow-2xl">
              <Image src="/vintage2.png" alt="Vintage Car Lashing" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
