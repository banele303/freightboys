...
const features = [
  {
    ...
    description: "Professional offloading of vehicle shipments from containers with zero damage guarantee.",
  },
  {
    icon: ArrowDownToLine,
    title: "Used & New Rides",
    description: "Expert handling for both used and brand new vehicles arriving in South Africa.",
  },
  {
    icon: ShieldCheck,
    title: "Safety Inspected",
    description: "Immediate visual inspection following container opening to ensure vehicle integrity.",
  },
  {
    icon: Zap,
    title: "Fast Turnaround",
    description: "Efficient unpacking processes to release transport equipment quickly.",
  },
];

export default function ContainerOffloadingPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden bg-[#0a0a0a]">
        <div className="absolute inset-0 z-0">
          <Image 
            src="/new-tailand.png" 
            alt="Container Offloading Background" 
            fill 
        ...
        <div className="container mx-auto px-6 relative z-10 pt-20">
          ...
          >
            ...
            >
              Container <br />
              <span className="text-[#2563eb]">Offloading</span>
            </motion.h1>
            <motion.p
              variants={fadeInUp}
              className="text-lg md:text-2xl text-slate-300 max-w-2xl mx-auto mb-10 font-medium leading-relaxed drop-shadow-lg"
            >
              Professional unpacking and handling of new and used vehicles from shipping containers for the SADC market.
            </motion.p>
            <motion.div
              variants={fadeInUp}
              className="text-4xl md:text-6xl font-black text-[#2563eb] mb-12"
            >
              R 4,566.00 <span className="text-lg text-slate-400 font-medium italic">/ Container</span>
            </motion.div>
            <motion.div
              variants={fadeInUp}
            ...
            >
              <Button asChild size="xl" className="h-20 px-12 rounded-[24px] bg-[#2563eb] hover:bg-[#1d4ed8] text-white text-xl shadow-2xl shadow-blue-500/20 border border-white/10 group overflow-hidden relative font-black uppercase tracking-widest">
                <Link href="/contact" className="flex items-center gap-3">
                  <span className="relative z-10">Book Offloading</span>
      ...
      <section className="py-24 md:py-40">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              Precision <span className="text-[#2563eb] italic">Unpacking.</span>
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-lg md:text-2xl text-slate-500 font-medium italic max-w-3xl mx-auto"
            >
              We handle every vehicle with extreme care, ensuring that new and used rides reach their final destination in world-class condition.
            </motion.p>
          </motion.div>
      ...
      <section className="py-24 md:py-40 bg-slate-900 text-white relative overflow-hidden rounded-[60px] mx-6">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              Professional <span className="text-[#2563eb] italic">Handling.</span>
            </motion.h2>
            <motion.div
              variants={fadeInUp}
            ...
            >
              <div className="grid md:grid-cols-2 gap-8">
                {[
                   "Secure seal verification",
                   "Professional vehicle ramp extraction",
                   "Detailed condition reporting",
                   "Battery & fluid checks upon arrival",
                   "Short-term secure storage",
                   "Assistance with onward transit",
                   "Certified handling team",
                   "24/7 yard security",
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h2 className="text-4xl md:text-7xl font-black tracking-tighter mb-10 text-slate-900 leading-tight uppercase">
               Expert <span className="gradient-text italic">Offloading.</span>
            </h2>
            <p className="text-lg md:text-2xl text-slate-500 font-medium mb-16 max-w-3xl mx-auto italic leading-relaxed">
               Trust Freightboys with your containerized vehicle shipments for professional and safe unpacking every time.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-center">
              <Button asChild size="xl" className="h-20 px-12 rounded-[24px] btn-primary-new text-xl shadow-2xl">
                <Link href="/contact" className="flex items-center gap-3">
                  <MessageCircle className="h-6 w-6" /> Schedule Unpacking
                </Link>
              </Button>
