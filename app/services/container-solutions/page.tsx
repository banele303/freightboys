...
export default function ContainerSolutionsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden bg-[#0a0a0a]">
        <div className="absolute inset-0 z-0">
          <Image 
            src="/vintage4.png" 
            alt="Container Solutions Background" 
            fill 
        ...
        <div className="container mx-auto px-6 relative z-10 pt-20">
          ...
          >
            ...
            >
              Professional loading and unloading of cargo into containers. We ensure maximum safety standards for all your import and export operations.
            </motion.p>
            <motion.div
              variants={fadeInUp}
            ...
            >
              <Button asChild size="xl" className="h-20 px-12 rounded-[24px] bg-[#2563eb] hover:bg-[#1d4ed8] text-white text-xl shadow-2xl shadow-blue-500/20 border border-white/10 group overflow-hidden relative font-black uppercase tracking-widest">
                <Link href="/contact" className="flex items-center gap-3">
                  <span className="relative z-10">Book Container Team</span>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <motion.div
              ...
              className="space-y-8"
            >
              <h2 className="text-5xl font-black tracking-tighter text-slate-900 uppercase italic">Stuffing & <br/><span className="text-[#2563eb] italic">Unpacking.</span></h2>
              <p className="text-xl text-slate-500 font-medium leading-relaxed italic border-l-4 border-[#2563eb] pl-8">
                We specialize in the meticulous handling of diverse commodities. Whether it's LCL or FCL, our team ensures every inch of your container is optimized and secure.
              </p>
              <div className="space-y-4">
                {[
                  "Professional Container Stuffing (Export)",
                  "Expert Container De-stuffing (Import)",
                  "Strategic Cargo Weight Distribution",
                  "Lashing & Securing for Maritime Transit",
                  "Complete Inspection & Tally Reports",
                ].map((item, i) => (
            ...
            <div className="relative aspect-square rounded-[60px] overflow-hidden shadow-2xl border-8 border-slate-50">
              <Image src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=1200" alt="Container Yard" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 text-white rounded-[60px] mx-6 mb-12 overflow-hidden relative">
        <div className="absolute bottom-0 right-0 w-1/4 h-full bg-[#2563eb]/20 blur-[100px]" />
        <div className="container mx-auto px-6 text-center relative z-10">
           <h2 className="text-4xl md:text-6xl font-black mb-8 uppercase tracking-tighter italic">Secure Your <span className="text-[#2563eb]">Cargo.</span></h2>
           <p className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto italic font-medium">Industry-leading container solutions for South African businesses.</p>
           <Button asChild size="xl" className="h-20 px-12 rounded-[24px] btn-primary-new text-xl shadow-2xl">
              <Link href="/contact" className="flex items-center gap-3">
                <Package className="h-6 w-6" /> Book Container Team
              </Link>
           </Button>
        </div>
      </section>
