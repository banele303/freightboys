...
export default function ThailandVehicleImportPage() {
  return (
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden bg-[#0a0a0a]">
        ...
        <div className="container mx-auto px-6 relative z-10 pt-20">
          ...
          >
            ...
            >
              Thailand <br />
              <span className="text-[#2563eb]">Import</span>
            </motion.h1>
            <motion.p
              variants={fadeInUp}
              className="text-lg md:text-2xl text-slate-300 max-w-2xl mx-auto mb-10 font-medium leading-relaxed drop-shadow-lg"
            >
              Streamlined unpacking of import cargo, specializing in brand new vehicles arriving from Thailand. Professional showroom standards.
            </motion.p>
            <motion.div
              variants={fadeInUp}
              className="text-4xl md:text-6xl font-black text-[#2563eb] mb-12"
            >
              R 1,950.00 <span className="text-lg text-slate-400 font-medium italic">/ Unit Unpacking</span>
            </motion.div>
            <motion.div
              variants={fadeInUp}
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <motion.div
              ...
              className="space-y-8"
            >
              <h2 className="text-5xl font-black tracking-tighter text-slate-900 uppercase italic">New Vehicle <br/><span className="text-primary italic">Distribution.</span></h2>
              <p className="text-xl text-slate-500 font-medium leading-relaxed italic">
                Our facilities are optimized for the volume intake of brand new vehicles from Thailand. We handle the critical unpacking phase with dedicated care to maintain showroom standards.
              </p>
              <div className="space-y-4">
                {[
                  "Specialized Thailand 🇹🇭 import cargo unpacking",
                  "Dedicated handling for Brand New Vehicles",
                  "Secure offloading and temporary staging",
                  "Formalized inspection upon container opening",
                  "Efficient logistics chain support for rapid dispatch",
                ].map((item, i) => (
            ...
            <div className="relative aspect-square rounded-[60px] overflow-hidden shadow-2xl">
              <Image src="/new-tailand.png" alt="New Thailand Inventory" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
